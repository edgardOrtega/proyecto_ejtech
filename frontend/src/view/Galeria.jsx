        ...
        {!loading &&
          ...
          productos.map((product) => {
            ...
            const descripcionCorta =
              product.descripcion.length > 60 ? `${product.descripcion.slice(0, 60)}...` : product.descripcion;
              ...
              <Col key={product.id_producto} md={4} lg={3} className="mb-4">
                <Card className="shadow-sm p-3 rounded text-center" style={{ border: "3px solid yellow" }}>
                  ...
                  <Card.Body>
                    ...
                    <p className={`fw-bold ${stockVisual === 0 ? "text-danger" : ""}`}>Stock: {stockVisual}</p>
                    ...
                    <InputGroup className="mb-3 justify-content-center">
                      <Button
                        ...
                        onClick={() =>
                          setQuantities((prev) => ({
                            ...prev,
                            [product.id_producto]: Math.max(1, prev[product.id_producto] - 1),
                          }))
                        }
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setQuantities((prev) => ({
                            ...prev,
                            [product.id_producto]: prev[product.id_producto] + 1,
                          }))
                        }
